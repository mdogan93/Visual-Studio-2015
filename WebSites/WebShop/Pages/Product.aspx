...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table>
        ...
        <tr>
            ...
            <td><asp:Label ID="lblResult" runat="server"  ></asp:Label></td><br/>
        </tr>
        <tr>
            <td>Product Number: <asp:Label ID="lblItemNumber" runat="server"  ></asp:Label></td>
    
        </tr>
        <tr>
            <td>Product Number: <asp:Label ID="Label1" runat="server" Text="Available" CssClass="productPrice" ></asp:Label></td>
        </tr>
    </table>
</asp:Content>
